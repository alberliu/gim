...
type Message struct {
	...
	ReceiverType         ReceiverType  `protobuf:"varint,3,opt,name=receiver_type,json=receiverType,proto3,enum=pb.ReceiverType" json:"receiver_type,omitempty"`
	ReceiverId           int64         `protobuf:"varint,4,opt,name=receiver_id,json=receiverId,proto3" json:"receiver_id,omitempty"`
	ToUserIds            []int64       `protobuf:"varint,5,rep,packed,name=to_user_ids,json=toUserIds,proto3" json:"to_user_ids,omitempty"`
	...
	MessageContent       []byte        `protobuf:"bytes,7,opt,name=message_content,json=messageContent,proto3" json:"message_content,omitempty"`
	...
	Status               MessageStatus `protobuf:"varint,10,opt,name=status,proto3,enum=pb.MessageStatus" json:"status,omitempty"`
...
var fileDescriptor_17200129a46574b9 = []byte{
	...
	,
}
